...
import { InstanceTestsComponent } from './instance-tests.component';
...
describe('Instance Tests', () => {
  ...
  let fixture: ComponentFixture<InstanceTestsComponent>;
  let component: InstanceTestsComponent;
  ...
  beforeEach(async () => {
    ...
    fixture = TestBed.createComponent(InstanceTestsComponent);
  ...
  it('should get the instance componnets', () => {
    expect(store.dispatch).toBeCalledWith('findComponents', '12');
  });
  ...
  it('should show warning and falied tests by default', () => {
    expect(component.search.value).toEqual(expect.objectContaining({status: `${TestStatus.Warning},${TestStatus.Failed}`}));
  });
