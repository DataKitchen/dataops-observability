...
@Directive({
  selector: '[matColumnDef] ~ [sortDisabled]', // <- sibling selector: makes `sortDisabled` valid only as a sibling of matColumnDef
})
export class SortDisabledDirective implements OnInit {
