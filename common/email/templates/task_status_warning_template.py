__all__ = ["TaskStatusWarningTemplate"]
from common.constants.email_templates import TASK_STATUS_WARNING_TEMPLATE_NAME
from common.email.templates import BaseTemplate


class TaskStatusWarningTemplate(BaseTemplate):
    template_name: str = TASK_STATUS_WARNING_TEMPLATE_NAME
    subject: str = "Datakitchen - Task Warning"
          ...
          <td colspan="2">
            <table role="presentation"
              ...
              <tr>
                ...
                <!-- TITLE -->
                <td class="title">
                  Task Completed with Warnings&nbsp;<span class="title__status"><span>&#8226;</span></span>
                </td>
              </tr>
            </table>
          </td>
            ...
            <div class="summary">
              <table
                ...
                <tr>
                  ...
                  <td class="summary__value">Warning</td>
                </tr>
                <tr>
