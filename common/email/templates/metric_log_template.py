__all__ = ["MetricLogTemplate"]
from common.constants.email_templates import METRIC_LOG_TEMPLATE_NAME
from common.email.templates import BaseTemplate


class MetricLogTemplate(BaseTemplate):
    template_name: str = METRIC_LOG_TEMPLATE_NAME
    subject: str = "Datakitchen - Metric Log"
...
<head>
  ...
  <title>DataKitchen: Metric Log Alert</title>
  <style type="text/css">
    body {
      margin: 0;
      padding: 0;
              ...
              <tr>
                ...
                <td class="title">
                  <span class="title__status">
                    DataKitchen: Metric Log Alert&nbsp;<span>&#8226;</span>
                  </span>
                </td>
              </tr>
            </table>
          ...
          <td colspan="2" style="white-space: nowrap">
            ...
            <div class="summary">
              <table
                ...
                <tr>
                  <td class="summary__label">Metric Log</td>
                  <td class="summary__value">{{ metric_key }}: {{ metric_value }}</td>
                </tr>
                <tr>
