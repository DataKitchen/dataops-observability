__all__ = ["TestStatusTemplate"]
from common.constants.email_templates import TEST_STATUS_TEMPLATE_NAME
from common.email.templates import BaseTemplate


class TestStatusTemplate(BaseTemplate):
    template_name: str = TEST_STATUS_TEMPLATE_NAME
    subject: str = "Datakitchen - Test Status"
...
<head>
  ...
  <title>DataKitchen: Test Status Alert</title>
  <style type="text/css">
    body {
      margin: 0;
      padding: 0;
              ...
              <tr>
                ...
                <td class="title">&nbsp;
                  <span class="title__status">
                    DataKitchen: Test Status Alert&nbsp;<span>&#8226;</span>
                  </span>
                </td>
              </tr>
            </table>
          ...
          <td colspan="2" style="white-space: nowrap">
            ...
            <div class="summary">
              <table
                ...
                {{#each test_outcomes}}
                <tr>
                  <td class="summary__label">Test Status</td>
                  <td class="summary__value">{{this.name}}: {{ this.status }}</td>
                </tr>
                {{/each}}
                <tr>
