__all__ = ["TaskStatusStartedTemplate"]
from common.constants.email_templates import TASK_STATUS_STARTED_TEMPLATE_NAME
from common.email.templates import BaseTemplate


class TaskStatusStartedTemplate(BaseTemplate):
    template_name: str = TASK_STATUS_STARTED_TEMPLATE_NAME
    subject: str = "Datakitchen - Task Started"
            ...
            <div class="summary">
              <table
                ...
                <tr>
                  ...
                  <td class="summary__value">Started</td>
                </tr>
                <tr>
