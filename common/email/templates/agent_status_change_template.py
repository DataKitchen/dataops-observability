__all__ = ["AgentStatusChangeTemplate"]
from common.constants.email_templates import AGENT_STATUS_CHANGE_TEMPLATE_NAME
from common.email.templates import BaseTemplate


class AgentStatusChangeTemplate(BaseTemplate):
    template_name: str = AGENT_STATUS_CHANGE_TEMPLATE_NAME
    subject: str = "Datakitchen - Agent Offline"
    content: str = """
            ...
            <div class="summary">
              <table
                ...
                <tr>
                  ...
                  <td class="summary__value">{{ project.name }}</td>
                </tr>
                <tr>
                  <td class="summary__label">Key</td>
                  <td class="summary__value">
                    <a href="https://{{ company.ui_url }}/projects/{{ project.id }}/integrations" target="_blank">
                      {{ agent.key }}
                    </a>
                  </td>
                </tr>
                <tr>
                  <td class="summary__label">Tool</td>
                  <td class="summary__value">{{ agent.tool }}</td>
                </tr>
                <tr>
                  <td class="summary__label">Latest Heartbeat</td>
