__all__ = ["TaskStatusCompletedTemplate"]
from common.constants.email_templates import TASK_STATUS_COMPLETED_TEMPLATE_NAME
from common.email.templates import BaseTemplate


class TaskStatusCompletedTemplate(BaseTemplate):
    template_name: str = TASK_STATUS_COMPLETED_TEMPLATE_NAME
    subject: str = "Datakitchen - Task Completed"
            ...
            <div class="summary">
              <table
                ...
                <tr>
                  ...
                  <td class="summary__value">Completed</td>
                </tr>
                <tr>
