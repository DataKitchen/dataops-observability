__all__ = ["TaskStatusPendingTemplate"]
from common.constants.email_templates import TASK_STATUS_PENDING_TEMPLATE_NAME
from common.email.templates import BaseTemplate


class TaskStatusPendingTemplate(BaseTemplate):
    template_name: str = TASK_STATUS_PENDING_TEMPLATE_NAME
    subject: str = "Datakitchen - Task Pending"
            ...
            <div class="summary">
              <table
                ...
                <tr>
                  ...
                  <td class="summary__value">Pending</td>
                </tr>
                <tr>
