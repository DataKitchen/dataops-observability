__all__ = ["TaskStatusMissingTemplate"]
from common.constants.email_templates import TASK_STATUS_MISSING_TEMPLATE_NAME
from common.email.templates import BaseTemplate


class TaskStatusMissingTemplate(BaseTemplate):
    template_name: str = TASK_STATUS_MISSING_TEMPLATE_NAME
    subject: str = "Datakitchen - Task Missing"
            ...
            <div class="summary">
              <table
                ...
                <tr>
                  ...
                  <td class="summary__value">Missing</td>
                </tr>
                <tr>
