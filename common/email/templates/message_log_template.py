__all__ = ["MessageLogTemplate"]
from common.constants.email_templates import MESSAGE_LOG_TEMPLATE_NAME
from common.email.templates import BaseTemplate


class MessageLogTemplate(BaseTemplate):
    template_name: str = MESSAGE_LOG_TEMPLATE_NAME
    subject: str = "Datakitchen - Message Log"
...
<head>
  ...
  <title>DataKitchen: Message Log Alert</title>
  <style type="text/css">
    body {
      margin: 0;
      padding: 0;
              ...
              <tr>
                ...
                <td class="title">&nbsp;
                  <span class="title__status">
                    DataKitchen: Message Log Alert&nbsp;<span>&#8226;</span>
                  </span>
                </td>
              </tr>
            </table>
              ...
              <table
                ...
                <tr>
                  ...
                  <td class="summary__value">
                    <a href="https://{{ base_url }}/projects/{{ project_id }}"
                      target="_blank">
                      {{ project_name }}
                    </a>
                  </td>
                ...
                <tr>
                  <td class="summary__label">Component</td>
                ...
                <tr>
                  <td class="summary__label">Message Level</td>
                  <td class="summary__value">{{ log_level }}</td>
                </tr>
                <tr>
                  <td class="summary__label">Message Log</td>
                  <td class="summary__value">{{ message }}</td>
                </tr>
                <tr>
