__all__ = ["InstanceAlertTemplate"]
from common.constants.email_templates import INSTANCE_ALERT_TEMPLATE_NAME
from common.email.templates import BaseTemplate


class InstanceAlertTemplate(BaseTemplate):
    template_name: str = INSTANCE_ALERT_TEMPLATE_NAME
    subject: str = "Datakitchen - Instance Alert"
...
<head>
  ...
  <title>DataKitchen: Instance Alert</title>
  <style type="text/css">
    body {
      margin: 0;
      padding: 0;
              ...
              <tr>
                ...
                <td class="title">&nbsp;
                  <span class="title__status">
                    DataKitchen: Instance Alert&nbsp;<span>&#8226;</span>
                  </span>
                </td>
              </tr>
            </table>
          ...
          <td colspan="2" style="white-space: nowrap">
            ...
            <div class="summary">
              <table
                ...
                <tr>
                  <td class="summary__label">Alert Level</td>
                  <td class="summary__value">{{ alert_level }}</td>
                </tr>
                <tr>
                  <td class="summary__label">Alert Type</td>
                  <td class="summary__value">{{ alert_type }}</td>
                </tr>
                <tr>
